...
update products set name = "インクジェットプリンタ" where id = "I-004"; select * from products;
-- exercise-U2. 製品IDが「I-004」の製品の価格を8800円に変更する。
update products set price = "8800" where id = "I-004"; select * from products;
-- exercise-U3. すべての製品の価格を25%OFFにする。
update products set price = price * 0.75; select * from products;

-- exercise-I1. 製品IDが「I-005」、製品名「タブレットPC」、価格「68000」のレコードを追加する
insert into products (id, name, price) values ('I-005', 'タブレットPC', 68000); select * from products;

-- exercise-D1. 製品IDが「I-005」の製品を削除する。
delete from products where id = "I-005"; select * from products;
-- exercise-D2. すべての製品を削除する。
delete from products; select * from products;